...
from config import LIVE_ODDS_BET_ID_OVER05_HT, LIVE_ODDS_BET_ID_OVER15_HT

# Mappa market -> bet id API-Football per le quote live (usata dall'EV gate).
LIVE_ODDS_BET_IDS = {MARKET_NEXT_GOAL: 5}
if LIVE_ODDS_BET_ID_OVER05_HT > 0:
    LIVE_ODDS_BET_IDS[MARKET_OVER05_HT] = LIVE_ODDS_BET_ID_OVER05_HT
if LIVE_ODDS_BET_ID_OVER15_HT > 0:
    LIVE_ODDS_BET_IDS[MARKET_OVER15_HT] = LIVE_ODDS_BET_ID_OVER15_HT
